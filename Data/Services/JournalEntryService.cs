...
namespace Journal_App.Data.Services
{
    public class JournalEntryService : IJournalEntryService
    {
           ...
           DateTime? entryDate = null)
        {
            try
            {
                var date = entryDate?.Date ?? DateTime.UtcNow.Date;
                ...
                if (existingEntry != null)
                    throw new InvalidOperationException("An entry already exists for this date. Please update the existing entry.");
